//////////////////////////////////////////////////////
//
//	File name: MonoAnalyzerPFMET.cc
//	author: Shih Lin
//	Purpose: THe cause of large MET is one of monopoles 
...
//	output:Monopole_PFMET_*000.root
/////////////////////////////////////////////////////
#include "iostream"
...
//        cout<<"ratio of electronlike "<<(double)electronLike/(double)EcalShowerNum<<endl;
	...
	cout<<endl<<"TotalPhotonLike	"<<TotalPhotonLike<<endl;
	cout<<"TotalElectronLike	"<<TotalElectronLike<<endl;
...
{
	cout<<"hello"<<endl;
	TFile *oFile = new TFile("Monopole_PFMET_1000.root","recreate");
