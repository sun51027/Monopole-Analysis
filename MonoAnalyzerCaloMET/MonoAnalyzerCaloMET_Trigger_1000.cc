...
void MonoAnalyzerCaloMET_Trigger_1000()
{
	cout<<"hello"<<endl;
	TFile *oFile = new TFile("Monopole_CaloMETTrigger_2018_1000_.root","recreate");
	cout<<"new file line pass"<<endl;

	TFile *fin = new TFile("MonoNtuple2018_MC_1000_0722.root");
