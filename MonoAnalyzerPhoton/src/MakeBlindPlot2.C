...
TH2F *MakeBlindPlotSig(TChain *Mono, int Unblind=3){
//TH2F *MakeBlindPlotSig(TTree *Mono, int Unblind=3){
    ...
    double x[4]={0, 65, 85, 105};
    double y[4]={0, 8, 18, 60}; 
    double VetoX = 0.0;
    double VetoY = 0.0;
    ...
    float Run, Event, SatSubHits, SubHits, Dist, HIso, XYPar0, XYPar2, RZPar0, RZPar1, RZPar2,Eta, seedFrac,ClustEE, passHLT_Photon200,cand_e55;
    ...
    //Mono->SetBranchAddress("ClustEE", &ClustEE);
...
//		           evtPassesPho200L1 == 1 &&	
//	      passHLT_Photon200 == 1 &&
	      //(clust_E*(sin(2*atan(exp(-1*Eta))))) > 175 && 
